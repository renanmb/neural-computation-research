...
Additionally, we are exploiting this relationship by carefully crafting a modified transformers model so we can benefit from several engineering tools, techniques, softwares and hardware that have been matured and extensively tested given the popularity and widespread use of transformers. Further studies are required to develop and validate a better architecture that better represents Neural Population Dynamics.
